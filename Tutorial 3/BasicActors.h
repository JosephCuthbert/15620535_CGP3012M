...
namespace PhysicsEngine
{
	...
	public:
		...
		// - denisty: 1kg/m^3
		Box(const PxTransform& pose=PxTransform(PxIdentity), PxVec3 dimensions=PxVec3(0.1f,.5f,.8f), PxReal density=1.f) 
			: DynamicActor(pose)
		{ 
	...
	public:
		...
		// - dimensions: 1m x 1m x 1m
		// - denisty: 1kg/m^3
		Box2(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			:StaticActor(pose)
		{
			CreateShape(PxBoxGeometry(dimensions), density);
		}
	...
	public:
		...
		// - dimensions: 1m x 1m x 1m
		// - denisty: 1kg/m^3
		base(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(5.f, 10.f, 10.f), PxReal density = 1.f)
			: StaticActor(pose)
		{
			CreateShape(PxBoxGeometry(dimensions), density);
		}
